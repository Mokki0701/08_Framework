...
//			
//			req.getRequestDispatcher("/templates/common/main.html").forward(request, response);
			// 이렇게 forward로 보내면 에러 주소창이 아니라 홈 주소창이 떠서>??? 이런거 신경쓰느라 그런겅가>..???
		}
		...
		// 로그인 되어있는 경우
			...
			// 다음 필터로 요청/응답 객체 전달
			// (만약 없다면 Dispatcher Servlet으로 전달)
