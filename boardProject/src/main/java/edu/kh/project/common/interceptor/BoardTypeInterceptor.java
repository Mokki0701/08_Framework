 ...
 *  
 *  
 *  * HanlderInterceptor 인터페이스를 상속 받아서 구현해야한다.
 *  
...
public class BoardTypeInterceptor implements HandlerInterceptor {
	...
	@Autowired
	private FreeBoardService service2;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// allpication scope에 "boardTypeList"가 없을 경우
		if(application.getAttribute("boardTypeList") == null) {
			
			// boardTypeList 조회 서비스 호출
			List<Map<String, Object>> boardTypeList = service.selectBoardTypeList();
			List<Map<String, Object>> boardTypeList2 = service2.selectBoardTypeList();
			
			// 조회 결과를 application scope에 추가
			application.setAttribute("boardTypeList", boardTypeList);
			application.setAttribute("boardTypeList2", boardTypeList2);
