...
public class ParameterController {
	...
	public String paramTest1(HttpServletRequest req) {
		...
		String inputAddress = req.getParameter("inputAdress");
	...
	public String ParamTest2(
			...
			@RequestParam(value="publisher", required = false, defaultValue = "네이버 시리즈") String publisher
			) {
	...
	public String ParamTest3(
		...
		// -> 문제점 : key(name속성값)이 중복되면 엎어쓰기가 된다!
